...
use crate::tray_application::{self, Application};
...
where
    A::Theme: tray_application::DefaultStyle,
{
    title: String,
    scale_factor: f64,
    viewport: Viewport,
    ...
    theme: A::Theme,
    appearance: tray_application::Appearance,
}
    ...
    A::Theme: tray_application::DefaultStyle,
{
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("tray_application::State")
