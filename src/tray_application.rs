...
use iced_winit::settings::{LiveTraySettings, TraySettings};
    ...
    Self::Theme: DefaultStyle,
{
    ...
    ///
    /// [`Error`]: crate::Error
    fn run(settings: Settings<Self::Flags>, tray_settings: TraySettings) -> crate::Result
    where
        Self: 'static,
    {
        ...
        Ok(crate::shell::tray_application::run::<
            Instance<Self>,
            Self::Executor,
            crate::renderer::Compositor,
        >(settings.into(), renderer_settings, tray_settings)?)
    }
}
...
impl<A> crate::runtime::tray_window::Program for Instance<A>
where
    A: Application,
    A::Theme: DefaultStyle,
{
...
impl<A> crate::shell::tray_application::Application for Instance<A>
where
    A: Application,
    A::Theme: DefaultStyle,
{
